    ...
    <div className="elipse-div" style={{ width: "100%", textAlign: 'center' }} data-aos="fade-left">
      ...
      <Row className="row-about">
            ...
            {props.checkBox ? (
              <>
                ...
                <p className="about-text" >
                  Hola!, Mi Nombre es Ayelen Fernandez, Soy de Argentina, tengo 21 años, Estudio la carrera de
              ...
              <>
                <p className="about-text">
                  Hi, My name is Ayelen Fernandez, I am from Argentina, I am 21 years old, I am studying Computer
        ...
        <Col data-aos="fade-left">
          ...
          <div >
            <img  className="elipse-img" src={elipse2} alt="elipse1" style={{ textAlign: 'center', marginLeft: "15%", marginTop:"5%" }} />
